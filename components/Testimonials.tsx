...
export default function Testimonials() {
  return (
    <section className="bg-gray-950 py-28 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-yellow-400 text-sm font-semibold uppercase tracking-widest">Bewertungen</span>
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-gray-500 text-sm">· Early Adopters</span>
          </div>
        </div>
          ...
          {testimonials.map((t) => (
            <div key={t.name} className="glass rounded-2xl p-6 card-hover">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full glass-brand flex items-center justify-center text-xl">
                  {t.avatar}
                </div>
                <div>
